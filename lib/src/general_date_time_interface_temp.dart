...
abstract class GeneralDateTimeInterfaceTemp<T>
  ...
  static GeneralDateTimeInterfaceTemp
      now<T extends GeneralDateTimeInterfaceTemp>() {
  ...
  /// [GeneralDateTimeInterfaceTemp] as well as native [DateTime] objects.
  /// Returns:
  ...
  /// ```
  /// Throws [ArgumentError] if [other] is not a [GeneralDateTimeInterfaceTemp] or [DateTime].
  @override
  int compareTo(dynamic other) {
    final DateTime selfDate = toDateTime();
    if (other is GeneralDateTimeInterfaceTemp) {
  ...
  /// - Another object implementing [GeneralDateTimeInterfaceTemp], or
  ...
  /// - An object implementing [GeneralDateTimeInterfaceTemp], or
  /// - A native [DateTime] instance.
  ...
  /// b.isAfter(a); // false
  /// ```
  /// Throws an [ArgumentError] if [other] is not a [GeneralDateTimeInterfaceTemp] or [DateTime].
  ...
  bool operator ==(Object other) =>
      ...
      other is GeneralDateTimeInterfaceTemp &&
